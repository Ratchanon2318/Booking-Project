...
<h1>รายละเอียดห้องประชุม</h1>
    ...
    ?>
            ...
            <div class="room-card">
                <a href="Meeting_room_details_user.php?room_id=<?php echo $room_id; ?>" style="display: flex; align-items: center;">
                    <?php echo '<img src="room_images/'.$row['room_id'].'.jpg?'.time().'" alt="'.$row['room_name'].'">'; ?>
                </a>
                <div>
                    <a href="Meeting_room_details_user.php?room_id=<?php echo $room_id; ?>" style="text-decoration: none; color: inherit;">
                        <h3><?php echo $room_name; ?></h3>
